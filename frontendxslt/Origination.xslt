 ...
 My global page header/footer (can be customized)
  ...
  <xsl:template name="my_page_header">
    <span id="QL" style="display:inline-block;">
      ...
      <img src="http://guru/images/Banner-color-bar.png" alt="color bar" style="height:8px; width:100%; min-width:754px;"/>
    </span>

  </xsl:template>

  <xsl:template name="my_page_footer">
    <span style="width:100%; background-image:url('http://guru/images/Banner-Textured-Banner.png');" class="p">
      <xsl:text disable-output-escaping="yes">         &lt;div class="footer" style="height: 68px; background-image:url('http://guru/images/Banner-Textured-Banner.png'); "&gt;
         &lt;body&gt;
         &lt;img style="float:top; display:block; width:100%; min-width:754px; height:8px;" src="http://guru/images/Banner-color-bar.png" alt="color bar" /&gt;
         &lt;div align="center"&gt;
         &lt;a href="http://quniverse/teams/CapitalMarkets/Pages/default.aspx" target="_blank"&gt;
          &lt;img style="height:50px; border:none; float:right; padding-top:2px;" alt="PLAB" src="http://guru/images/plab-logo.png" border="0" &gt;
         &lt;/a&gt;
  ...
  <xsl:template name="helplinks_sidebar">
    <div id="helplinks_container_l" class="sidebar-element">
      ...
      <div id="helplinks-body" class="helplinks-body">
        ...
        <div class="sb-l-res">
          <a target="_blank" href="http://quniverse/teams/CapitalMarkets/secondary_public_docs/QUICKENMARKETUPDATE.xlsm">Market Update</a>
        </div>
        <div class="sb-l-res">
        ...
        <xsl:if test="$show_contacts='1'">
          ...
          <div class="sb-l-res">
            <a href="mailto:ProductLab@Quickenloans.com">Product Lab</a>
          </div>
          <div class="sb-l-res">
          ...
          <div class="sb-l-res">
            <a target="_blank" href="http://quniverse/teams/capitalmarkets/Pages/Product%20Announcements.aspx">Product Announcements</a>
          </div>
        </xsl:if>
      </div>
    </div>
        ...
        <span>
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              ...
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_All'">
              ...
              <input type="hidden" name="site" value="Guru_All"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_Agency'">
              ...
              <input type="hidden" name="site" value="Guru_Agency"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_FHA'">
              ...
              <input type="hidden" name="site" value="Guru_FHA"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_FHA-FICO'">
              ...
              <input type="hidden" name="site" value="Guru_FHA-FICO"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_VA'">
              ...
              <input type="hidden" name="site" value="Guru_VA"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_Jumbo'">
              ...
              <input type="hidden" name="site" value="Guru_Jumbo"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_Purchase'">
              ...
              <input type="hidden" name="site" value="Guru_Purchase"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
          ...
          <div class="form-container">
            <form method="GET" action="http://gsa/search">
              <input type="hidden" name="q" value="{$space_normalized_query}"/>
              <xsl:choose>
                <xsl:when test="PARAM[@name='site']/@value='Guru_CSB'">
              ...
              <input type="hidden" name="site" value="Guru_CSB"/>
              <input type="hidden" name="client" value="{$frontend_name}"/>
              <input type="hidden" name="output" value="xml_no_dtd"/>
              <input type="hidden" name="proxystylesheet" value="{$frontend_name}"/>
              <input type="hidden" name="filter" value="0"/>
